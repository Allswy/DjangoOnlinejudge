...
def get_max_articleid_commentid():
    from onlinejudge.models import Article
    return Article.objects.latest().pk
...
def get_blog_setting():
    ...
    if value:
        ...
        from onlinejudge.models import OnlinejudgeSettings
        if not OnlinejudgeSettings.objects.count():
            setting = OnlinejudgeSettings()
            ...
            setting.save()
        value = OnlinejudgeSettings.objects.first()
